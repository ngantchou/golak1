...
/// The callback used by [RichReorderableListView] to move an item to a new
/// position in a list.
///
...
/// [RichReorderableListView] will need to account for this when inserting before
/// [newIndex].
///
/// {@tool sample}
///
...
class RichReorderableListView extends StatefulWidget {
  ...
  /// underlying list.
  ///
  /// This [RichReorderableListView] calls [onReorder] after a list child is dropped
  /// into a new position.
  final ReorderCallback onReorder;

  @override
  _RichReorderableListViewState createState() =>
      _RichReorderableListViewState();
}
...
class _RichReorderableListViewState extends State<RichReorderableListView> {
  ...
  final GlobalKey _overlayKey =
      GlobalKey(debugLabel: '$RichReorderableListView overlay key');
